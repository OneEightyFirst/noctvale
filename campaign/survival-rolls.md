...
Part of the [post-game sequence](post-game.md) (Step 4). After scenario
...
- The **winner** rolls on the battlefield location's Survival table.
...
| 2d6 | Result |
|---|---|
| 2 | **Mishap: Roadside Ambush** — choose 1 surviving fighter; that fighter rolls on the [Doom Table](post-game.md#step-3-doom-table). |
...
- Scenario rewards are static and should be the strongest reward lane.
- Survival Rolls are random and sit below scenario rewards.
- The winning retinue controls the battlefield and rolls on the location table.
- The losing retinue retreats and rolls on the Generic Survival table.
- In a draw, neither retinue controls the battlefield; both roll Generic.
- Looting is weaker than Survival Rolls and happens during the battle.
