...
Criticals are determined by weapon triangles.
...
Advantage grants critical hits on 6s.

---

# Magic Triangles

Two separate magic triangles exist.
...
Firearms gain criticals against all targets.
...
6   Stand up with 1 Wound and perform one additional action
...
If a stunned fighter is hit by any attack, they go Out of Action.

---

## Help Action

A friendly fighter within 1" may attempt to help.

Roll 1d6:

1   Fighter goes Out of Action
2–3 No effect
4–5 Fighter becomes Downed
...
A fighter within 1" of a stunned enemy may perform a Mercy Kill.
...
Charge  
Move up to movement value and must end in engagement range.

Climb  
Move vertically at half movement. Cannot end in engagement.
...
Melee  
Attack an enemy in engagement range.
...
Recover  
Attempt to stand from Downed.

Help  
Assist a stunned ally.

Mercy Kill  
Execute a stunned enemy.
...
When attacking multiple enemies:
...
Spells use 2d6 casting rolls.

Double 1s cause a Mishap.

Every spell has a negative result representing magical backlash.

Each magic class contains at least one ranged damage spell similar to Arcane Bolt.
...
Resolve the best 3 dice as discoveries on the location table.

---

## Push the Search

Players may choose to push.
