...
- [ ] **Remove Werebeasts migration shim** — `normalizeRetinue` in `app/src/lib/retinue.js` remaps `traditionId: "beastmen"` → `"werebeasts"`. Remove after ~2026-07-14 once live retinues have been resaved.
