...
- Line of sight is a simple visible-or-not check from the firing fighter's PoV; ignored base overhang avoids sculpt arguments
- Any intervening terrain beyond 1" from the shooter grants cover — fast to adjudicate without hugging-your-own-wall edge cases
