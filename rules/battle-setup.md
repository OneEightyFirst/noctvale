...
- Use **Scramble** to move across **difficult terrain** at half **Movement** (see [Actions — Scramble](actions.md#scramble)). A fighter may end their movement on **difficult terrain**, but they must be placed standing on their own. If that is not possible, move back along the path of movement until the fighter can be placed stably.
