...
| Halberd | +2 | +1 | Spear | Reach, versatile |
...
Firearms use the **2d6 loading gate**. Double 1s = Misfire, double 6s = Overcharge. Firearms gain **critical hits against all targets** (outside the weapon triangle).

| Weapon | Range | Difficulty | +Mt | +Lk | Notes |
|---|---|---|---|---|---|
| Pistol | 0"–12" | 6+ | +3 | +1 | No min range |
| Long Rifle | 3"–30" | 7+ | +4 | +1 | Long range, hard to load |
| Blunderbuss | 0"–10" | 6+ | +4 | — | No min range, short range, brutal |
| Musket | 3"–24" | 6+ | +3 | +2 | Standard infantry firearm |
...
- Firearms are significantly stronger than conventional ranged weapons (+3/+4 Mt) but gated behind the 2d6 loading check — high risk, high reward
