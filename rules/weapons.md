...
**Flintlock** may be applied to any firearm when bought: **−25 Crowns**, **Single Shot** (one fire per battle; cannot reload). Example: Pistol (90) with Flintlock = **65 Crowns**.

### Firearm-only rules

Firearms are fired with the **Ranged** action.
