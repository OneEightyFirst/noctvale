...
| -------- | -------------------------- | ------------------------------------------------------------------ |
| Silver   | +40 (added to weapon cost) | **+1 CC** or **+1 RC** vs fighters with **Undead** or **Werebeast** — whichever **Hit** attribute the weapon uses |
...
Requires **Animal Handling** on the **Handler** (see [Feats — Animal Handling](feats.md#animal-handling)). Each **Handler** fields one **Companion**; companions do **not** use weapon slots.

Rules and profiles: [Companions](companions.md#companions).
