...
- Humans are the true baseline (all 3s except Sa 4), Elves are agile and mystical (Lk 4, Wi 4, fast), Dwarves are tough and sturdy (Mt 4, slow) — species identity is expressed as specialty bonuses rather than crippling weaknesses
