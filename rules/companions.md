...
Companions with **Tamed** use their **Handler**'s **Movement**, **Will**, and **Sanity** instead of the profile values for those attributes.

All other attributes use the profile. **Might**, **Skill**, **Close Combat**, and **Ranged Combat** are never copied from the **Handler**.
...
Some **Companions** project a **Sphere of Influence** — the same term used for **Icon** and **Instrument** gear (see [Equipment — Sphere of Influence](gear.md#sphere-of-influence)).
...
**Unarmed attack** — see **Swarm** in [Retinue — Swarm](retinue-building.md#swarm).
