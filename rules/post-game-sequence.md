...
| 3 | **Scarred** — return next battle; permanently **−1** to one attribute of your choice (minimum 1). |
...
Permanent injuries reduce attributes. Attributes cannot drop below **1**. Campaign advancement may later raise attributes again (max **6**).
...
| 6 | **Old Wound** — W −1. |
| 7 | **Surface Scars** — no attribute loss; the fighter is **Marked** (flavor only, or scenario hook). |
