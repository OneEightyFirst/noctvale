...
const RULES_OUTLINE = [
    ...
    children: [
      {
        ...
        anchor: "weapons",
        children: [
          { label: "Weapon proficiencies", articleId: "equipment", anchor: "weapon-proficiencies" },
          { label: "Firearms", articleId: "equipment", anchor: "firearms" },
          { label: "Bombs", articleId: "equipment", anchor: "bombs" },
        ],
      },
      {
        label: "Equipment",
        ...
        anchor: "equipment",
        children: [
          { label: "Armor", articleId: "equipment", anchor: "armor" },
          { label: "Shields", articleId: "equipment", anchor: "shields" },
          { label: "Alchemy", articleId: "equipment", anchor: "alchemy" },
          { label: "Sphere of Influence", articleId: "equipment", anchor: "sphere-of-influence" },
        ],
      },
      {
        label: "Companions",
        ...
        anchor: "companions-2",
        children: [
          { label: "Roster and deployment", articleId: "equipment", anchor: "roster-and-deployment" },
          { label: "Companion profiles", articleId: "equipment", anchor: "companion-profiles" },
        ],
      },
    ],
  },
  {
    ...
    articleId: "campaign",
    children: [
      { label: "How to Run a Campaign", articleId: "campaign", anchor: "how-to-run-a-campaign" },
      {
        label: "Leveling and Advancement",
        articleId: "campaign",
        anchor: "leveling-and-advancement",
        children: [
          { label: "Earning XP", articleId: "campaign", anchor: "earning-xp" },
          { label: "Spending XP — Advancement Rolls", articleId: "campaign", anchor: "spending-xp-advancement-rolls" },
          { label: "Feat Advancement Table", articleId: "campaign", anchor: "feat-advancement-table" },
          { label: "Stat Advancement Table", articleId: "campaign", anchor: "stat-advancement-table" },
        ],
      },
      {
        label: "Scenarios",
        ...
        anchor: "scenarios",
        children: [
          { label: "Scenario Rules", articleId: "campaign", anchor: "scenario-rules" },
          { label: "Loot the Dead", articleId: "campaign", anchor: "loot-the-dead" },
          { label: "The Forest Creeps Ever Onward", articleId: "campaign", anchor: "the-forest-creeps-ever-onward" },
          { label: "There's a Reason They Have a Horn", articleId: "campaign", anchor: "theres-a-reason-they-have-a-horn" },
        ],
      },
      {
        label: "Post-Game Sequence",
        articleId: "campaign",
        anchor: "post-game-sequence",
        children: [
          { label: "Sequence at a Glance", articleId: "campaign", anchor: "sequence-at-a-glance" },
          { label: "Step 1: Scenario Results", articleId: "campaign", anchor: "step-1-scenario-results" },
          { label: "Step 2: Casualty Table", articleId: "campaign", anchor: "step-2-casualty-table" },
          { label: "Step 3: Companion Recovery", articleId: "campaign", anchor: "step-3-companion-recovery" },
          { label: "Step 4: Doom Table", articleId: "campaign", anchor: "step-4-doom-table" },
          { label: "Step 5: Survival Rolls", articleId: "campaign", anchor: "step-5-survival-rolls" },
          { label: "Step 6: Economy", articleId: "campaign", anchor: "step-6-economy" },
          { label: "Step 7: Experience & Advancement", articleId: "campaign", anchor: "step-7-experience-advancement" },
        ],
      },
      {
        label: "Survival Rolls",
        articleId: "campaign",
        anchor: "survival-rolls",
        children: [
          { label: "Reward Roll Rule", articleId: "campaign", anchor: "reward-roll-rule" },
          { label: "Sequence at a Glance", articleId: "campaign", anchor: "sequence-at-a-glance-2" },
          { label: "Survival Tables", articleId: "campaign", anchor: "survival-tables" },
          { label: "Battlefield Location Table", articleId: "campaign", anchor: "battlefield-location-table" },
          { label: "Generic Survival Table", articleId: "campaign", anchor: "generic-survival-table" },
          {
            label: "Location Survival Tables",
            articleId: "campaign",
            anchor: "location-survival-tables",
            children: [
              { label: "Ruins", articleId: "campaign", anchor: "ruins" },
              { label: "Chapel", articleId: "campaign", anchor: "chapel" },
              { label: "Abandoned Village", articleId: "campaign", anchor: "abandoned-village" },
              { label: "Hidden Grove", articleId: "campaign", anchor: "hidden-grove" },
              { label: "Ancient Road", articleId: "campaign", anchor: "ancient-road" },
              { label: "Graveyard", articleId: "campaign", anchor: "graveyard" },
            ],
          },
        ],
      },
      {
        ...
        anchor: "economy",
        children: [
          { label: "Campaign Resources", articleId: "campaign", anchor: "campaign-resources" },
          { label: "What Are Relics?", articleId: "campaign", anchor: "what-are-relics" },
          { label: "Selling Relics", articleId: "campaign", anchor: "selling-relics" },
          { label: "Discount Bands", articleId: "campaign", anchor: "discount-bands" },
          { label: "Example: Counting the Cost", articleId: "campaign", anchor: "example-counting-the-cost" },
        ],
      },
    ],
  },
