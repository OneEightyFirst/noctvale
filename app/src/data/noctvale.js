...
export const SPELLS = {
  Light: [
    ...
    { id: "shield-of-faith", name: "Shield of Faith", castingStat: "Wi", hit: "-", difficulty: "10+", mt: "-", sk: "-", range: `12"`, effect: `Target friendly fighter gains +2 red defense dice until the start of the caster's next activation`, mishap: "" },
