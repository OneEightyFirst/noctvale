...
export const TRADITIONS = [
  ...
  },
  {
    ...
    domain: "Mortal",
    allowed: ["knights", "folk"],
    rules: ["When a friendly fighter performs Mercy Kill, they may capture the target instead. Resolve Mercy Kill normally. If the target would go Out of Action, they become Captured and go Out of Action."],
  },
  {
    id: "alchemists",
    name: "Alchemists",
...
export const SPELLS = {
  ...
  Infernal: [
    ...
    { id: "nightmare-visage", name: "Nightmare Visage", castingStat: "Sa", hit: "-", difficulty: "11+", mt: "-", sk: "-", range: `12"`, effect: `Target friendly fighter within 12". The caster maintains this spell, and the target projects Fear (6") while it remains in effect. At the end of each round, the caster makes one Sa check; on a failure, the spell ends. It also ends immediately if the caster becomes Downed or Stunned, or goes Out of Action`, mishap: "" },
  ],
  Nature: [
...
export const WEAPON_KEYWORD_RULES = {
  ...
  "Spell focus": "A fighter wielding a Staff has Spell focus. When purchased, choose Will or Sanity for this Staff. When this fighter resolves an Attack spell while wielding this Staff, add the spell's printed +Skill value to the chosen attribute instead of the fighter's Skill. Fixed Skill values are not affected.",
...
export const EQUIPMENT = [
  ...
  { id: "staff", name: "Staff", kind: "weapon", group: "Two-Handed melee", proficiency: "two-handed", cost: 20, slots: 2, alwaysAllowed: true, rules: ["Hands 2H. +Mt +1, +Sk +1. Neutral. Reach. Spell focus. Any fighter may equip a Staff.", "When purchased, choose Will or Sanity for this Staff.", "When this fighter resolves an Attack spell while wielding this Staff, add the spell's printed +Sk value to the chosen attribute instead of the fighter's Sk. Fixed Sk values are not affected."] },
  ...
  { id: "smoke-bomb", name: "Smoke Bomb", kind: "alchemy", group: "Alchemy", cost: 25, slots: 1, rules: [`Alchemical Bomb. Any fighter may equip, regardless of domain or keyword. Ranged action: target a point within Might in inches, then make a Skill check. Pass places the blast on that point; fail scatters d3" via scatter die. Single Shot, 6" blast, Smoke.`] },
  ...
  { id: "giant-rat", name: "Giant Rat", kind: "companion", group: "Companions", cost: 30, slots: 0, requiresFeat: "animal-handling", companionProfile: { stats: { CC: 2, Mt: 2, Sk: 4, W: 1 }, tether: 3, keywords: ["Tamed"] }, rules: [`Requires Animal Handling. CC 2, Mt 2, Sk 4, W 1, Tether 3".`, "Bite: Melee attack using profile Might / Skill. Poison: Unblocked hits add 1 Affliction token in addition to normal Wounds."] },
  { id: "bear", name: "Bear", kind: "companion", group: "Companions", cost: 150, slots: 0, requiresFeat: "animal-handling", companionProfile: { stats: { CC: 3, Mt: 5, Sk: 2, W: 3 }, tether: 3, keywords: ["Large", "Tamed"] }, rules: [`Requires Animal Handling. CC 3, Mt 5, Sk 2, W 3, Tether 3".`, "Maul: Melee attack using profile Might / Skill (no weapon).", "Thick Hide: For the purpose of building its defense pool, this Companion is treated as wearing Light Armor and adds 1 Skill defense die. This is natural armor, not equipped gear.", "Large: Cannot perform Hide."] },
  { id: "giant-spider", name: "Giant Spider", kind: "companion", group: "Companions", cost: 100, slots: 0, requiresFeat: "animal-handling", companionProfile: { stats: { CC: 3, Mt: 2, Sk: 4, W: 1 }, tether: 6, keywords: ["Large", "Tamed"] }, rules: [`Requires Animal Handling. CC 3, Mt 2, Sk 4, W 1, Tether 6".`, "Bite: Melee attack using profile Might / Skill (no weapon). Poison: Unblocked hits add 1 Affliction token in addition to normal Wounds.", "Wall-Crawler: This Companion moves up to its full Movement when performing Climb instead of half Movement.", "Webbed: When this Companion performs Mercy Kill, it may capture the target instead. Resolve Mercy Kill normally. If the target would go Out of Action, they become Captured and go Out of Action.", "Large: Cannot perform Hide."] },
