...
export const ARCHETYPES = {
  ...
  cult: {
    ...
    feats: [
      { id: "blood-for-the-rite", name: "Blood for the Rite", rules: [`Once per battle, before this fighter makes an attribute check or casting roll, choose another friendly fighter within 12". That fighter suffers 1 Wound. Add +1 to the roll.`, "This Wound can reduce the chosen fighter to 0 Wounds and cause them to become Downed."] },
...
export const DOMAIN_FEATS = [
  ...
  { id: "thrill-of-agony", name: "Thrill of Agony", domains: ["Blood"], rules: ["When this fighter suffers 1 or more Wounds from an Attack Sequence, add 1 Might die to their next Melee attack this activation."] },
...
export const SPELLS = {
  Light: [
    { id: "radiant-strike", name: "Radiant Strike", castingStat: "Wi", hit: "RC", difficulty: "11+", mt: "5", sk: "+2", range: `12"`, effect: "Ranged attack; use 6 Mt / +2 Sk vs Undead and Daemons", mishap: "" },
    ...
    { id: "purge-the-faithless", name: "Purge the Faithless", castingStat: "Wi", hit: "CC", difficulty: "11+", mt: "3", sk: "+1", range: `3" blast from caster`, effect: "Hits all fighters in radius", mishap: "Caster takes the damage" },
  ...
  Arcane: [
    { id: "arcane-bolt", name: "Arcane Bolt", castingStat: "Wi", hit: "RC", difficulty: "11+", mt: "4", sk: "+3", range: `20"`, effect: "Ranged attack; fast, high-finesse", mishap: "" },
    ...
    { id: "fireball", name: "Fireball", castingStat: "Wi", hit: "RC", difficulty: "13+", mt: "4", sk: "+3", range: `18"`, effect: `Choose a point within 18". All fighters within large blast template are hit. On normal fail, fireball scatters. On pass, blast centers on chosen point`, mishap: "Blast template centers on the caster" },
  ...
  Infernal: [
    { id: "hellfire", name: "Hellfire", castingStat: "Sa", hit: "RC", difficulty: "10+", mt: "4", sk: "+3", range: `3"–18"`, effect: "Ranged spell attack. No Mishap.", mishap: "" },
    ...
    { id: "searing-gaze", name: "Searing Gaze", castingStat: "Sa", hit: "RC", difficulty: "12+", mt: "3", sk: "+3", range: `18"`, effect: `Draw a 1 mm thick straight line from the caster to a point up to 18" away in a direction you choose. Every fighter the line touches that is in line of sight of the caster is hit`, mishap: "Resolve the attack against the caster; the caster becomes Blinded until the end of their next activation" },
  ...
  Nature: [
    { id: "thorn-volley", name: "Thorn Volley", castingStat: "Wi", hit: "RC", difficulty: "12+", mt: "3", sk: "+2", range: `12"`, effect: "Ranged attack using standard flame template", mishap: "" },
  ...
  Necromancy: [
    ...
    { id: "bone-blast", name: "Bone Blast", castingStat: "Sa", hit: "CC", difficulty: "11+", mt: "4", sk: "+3", range: "Blast from caster", effect: "Blast template centered on the caster. All fighters under the template except the caster are hit", mishap: "Resolve the attack against the caster" },
    { id: "bone-circle", name: "Bone Circle", castingStat: "Sa", hit: "RC", difficulty: "12+", mt: "3", sk: "+4", range: `12"`, effect: `Choose a point within 12". Place a 3" blast template. Any fighter that starts in, ends in, or moves through it is hit. Affects friends and enemies. Lasts until the start of the caster's next activation`, mishap: "Zone centers on the caster" },
  ],
  Blood: [
    { id: "leech", name: "Leech", castingStat: "Sa", hit: "CC", difficulty: "12+", mt: "5", sk: "+3", range: "Touch", effect: "Touch attack; if target takes at least 1 Wound, caster heals 1 Wound", mishap: "" },
...
export const EQUIPMENT = [
  ...
  { id: "longbow", name: "Longbow", kind: "weapon", group: "Archery", proficiency: "archery", cost: 50, slots: 2, rules: [`Hands 2H. Range 3"-24". +Mt +1, fixed 5 Sk. Longer range, stronger accuracy.`] },
  { id: "crossbow", name: "Crossbow", kind: "weapon", group: "Archery", proficiency: "archery", cost: 65, slots: 2, rules: [`Hands 2H. Range 3"-24". Fixed 4 Mt, +Sk +2. Mechanical force, trained aim.`] },
  { id: "heavy-crossbow", name: "Heavy Crossbow", kind: "weapon", group: "Archery", proficiency: "archery", cost: 90, slots: 2, rules: [`Hands 2H. Range 3"-30". Fixed 5 Mt, +Sk +2. Slow, powerful.`] },
  ...
  { id: "long-rifle", name: "Long Rifle", kind: "weapon", group: "Firearms", proficiency: "firearms", cost: 125, slots: 2, rules: [`Requires Firearms domain feat; Mortal; forbids Caster. Hands 2H. Range 3"-30". Primer 10+. Fixed 5 Mt, +Sk +3. Critical hits on 5+.`] },
