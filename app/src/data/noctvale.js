...
export const DOMAIN_FEATS = [
  ...
  { id: "heave", name: "Heave", domains: ["Nature", "Blood", "Infernal"], rules: ["While this fighter is Active and within engagement range of at least one enemy fighter, they may perform Hurl.", `Hurl costs 1 action. Choose one enemy fighter within engagement range, or one Downed or Stunned enemy fighter within 1". The target makes a Sk check (d6 + Sk >= 8).`, "On fail, move the target d3 inches in a direction you choose. Active and Downed targets become Stunned after moving. Stunned targets remain Stunned.", "If the move stops because their base contacts terrain or an Active fighter's base, they suffer 1 hit at 2 Mt / 1 Sk. If another fighter's base is involved, that fighter also suffers the same hit and becomes Stunned.", "If this fighter performs Hurl during an activation, they cannot make a Melee attack during that activation."] },
...
export const SPELLS = {
  ...
  Arcane: [
    ...
    { id: "fireball", name: "Fireball", difficulty: "TBD", mt: "TBD", sk: "TBD", range: `18"`, effect: "Choose a point within 18 inches. All fighters within large blast template are hit. On normal fail, fireball scatters. On pass, blast centers on chosen point", mishap: "Blast template centers on the caster" },
    { id: "telekinesis", name: "Telekinesis", difficulty: "TBD", mt: "-", sk: "-", range: `12"`, effect: "Move any fighter up to 6 inches directly toward or away from the caster. No check required by the target", mishap: "TBD" },
    { id: "displacement", name: "Displacement", difficulty: "TBD", mt: "-", sk: "-", range: `12"`, effect: "Target friendly fighter instantly moves up to 6 inches in any direction. Ignores terrain, engagement, and intervening fighters. Cannot end inside terrain or another fighter's base", mishap: "TBD" },
    { id: "hoarfrost", name: "Hoarfrost", difficulty: "TBD", mt: "-", sk: "-", range: `18"`, effect: "Choose a point within 18 inches. Place a large blast template until the start of the caster's next activation. Affects friends and enemies. Movement ending in the zone triggers a Sk check and slide", mishap: "Blast centers on the caster" },
