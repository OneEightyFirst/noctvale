...
export const SPELLS = {
  Light: [
    ...
    { id: "horrors-relived", name: "Horrors Relived", castingStat: "Wi", hit: "RC", difficulty: "12+", mt: "Target's Sa", sk: "-", range: `12"`, effect: "Ranged attack; Strike Pool Mt equals the target's Sa attribute", mishap: "Caster takes the damage using target's Sa as Mt" },
  ...
  Infernal: [
    ...
    { id: "searing-gaze", name: "Searing Gaze", castingStat: "Sa", hit: "RC", difficulty: "12+", mt: "4", sk: "4", range: `18"`, effect: `Draw a 1 mm thick straight line from the caster to a point up to 18" away in a direction you choose. Every fighter the line touches that is in line of sight of the caster is hit`, mishap: "Resolve the attack against the caster; the caster becomes Blinded until the end of their next activation" },
  ...
  Necromancy: [
    { id: "deathbolt", name: "Deathbolt", castingStat: "Sa", hit: "RC", difficulty: "14+", mt: "-", sk: "6", range: `18"`, effect: "Ranged attack; all Skill dice, ignores armor", mishap: "" },
    ...
    { id: "wither", name: "Wither", castingStat: "Sa", hit: "-", difficulty: "11+", mt: "-", sk: "-", range: `12"`, effect: "Target enemy suffers Weakened until the start of the caster's next activation", mishap: "The caster suffers Weakened until the start of their next activation" },
    { id: "bone-blast", name: "Bone Blast", castingStat: "Sa", hit: "CC", difficulty: "11+", mt: "1", sk: "4", range: "Blast from caster", effect: "Blast template centered on the caster. All fighters under the template except the caster take a 1 Mt / 4 Sk hit", mishap: "Resolve the attack against the caster" },
